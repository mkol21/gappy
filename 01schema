-- GAP Retail Database Schema --
-- Revised version with fixes for foreign key issues and improved cohesion with use cases
-- Generated for: mkol21 | Generated on: 2025-04-05 23:48:46
...
CREATE TABLE shipments (
    ...
    ShipmentStatus ENUM('Processing', 'Shipped', 'In Transit', 'Delivered', 'Ready for Pickup', 'Picked Up', 'Failed') NOT NULL DEFAULT 'Processing',
...
-- Default data for critical lookup tables
